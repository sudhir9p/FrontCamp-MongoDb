...
db.airlines.aggregate([{ $match: { "destCountry": { $ne: "United States" } } }, { $group: { "_id": { destCity: "$destCity", destCountry: "$destCountry" }, avgPassengers: { $avg: "$passengers" } } }, { $sort: { avgPassengers: -1 } }, { $project: { _id: 0, city: "$_id.destCity", avgPassengers: 1 } }, { $limit: 3 }]);
