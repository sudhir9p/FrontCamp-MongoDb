...
db.airlines.aggregate([{ $match: { "destCountry": { $ne: "United States" } } }, { $group: { "_id": { destCity: "$destCity" }, avgPassengers: { $avg: "$passengers" } } }, { $project: { _id: 0, city: "$_id.destCity", avgPassengers: 1 } }, { $sort: { avgPassengers: -1 } }, { $limit: 3 }]);
